...
link <- paste('<a href="https://',bname1 ,'.a3s.fi/', fname,'">https://', bname1, '.object.pouta.csc.fi/', fname, '</a>', sep="")
cat("<li>", file="link.html", append=TRUE, sep="\n")
cat(link, file="link.html", append=TRUE, sep="\n")
cat("</li>", file="link.html", append=TRUE, sep="\n")
if ( add_md5sum == "yes" ){
	cat("<li>", file="link.html", append=TRUE, sep="\n")
	link <- paste('<a href="https://',bname1 ,'.a3s.fi/', md5file,'">https://', bname1, '.object.pouta.csc.fi/', md5file, '</a>', sep="")
	cat(link, file="link.html", append=TRUE, sep="\n")
	cat("</li>", file="link.html", append=TRUE, sep="\n")
