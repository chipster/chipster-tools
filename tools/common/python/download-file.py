# TOOL download-file.py: "Download file from URL" (Download a file from a URL address to the Chipster server. The URL must be visible to Chipster server. If it's not, download the file first to your laptop and upload it then to Chipster.)
