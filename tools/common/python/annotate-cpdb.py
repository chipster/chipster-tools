# TOOL annotate-cpdb.py: "Hypergeometric test for ConsensusPathDB" (ConsensusPathDB created by Herwig et al. contains pathway information from over 30 publicly available databases, including Reactome, KEGG, BioCarta and HumanCyc. This service is provided by the Max Planck Institute for Molecular Genetics. NOTE! Supports any data with human, mouse or yeast gene symbols or UniProt identifiers.)
...
def main():
    ...
    try:
        ...
        species = "human"
        print(
            "Parameters are undefined, using default values: "
            + input_type
            + ", "
...
def cpdb_tool(input, input_type, p_value_threshold, species):
    ...
    if len(id_to_gene_dict) == 0:
        raise Exception(
            "None of the provided genes can be mapped to "
    ...
    pathways = query_over_representation_analysis(
        input_gene_ids, input_type, p_value_threshold
    )
    ...
    for pathway in pathways:
        ...
        genes_mapped = convert_ids_to_genes(
            get_genes_mapped(pathway_genes, input_gene_ids), id_to_gene_dict
        )
...
def create_links(pathway_name, db):
    ...
    if db == "Reactome":
        ...
        linked_name = (
            '<a href="http://www.genome.jp/dbget-bin/www_bfind_sub?mode=bfind&max_hit=1000&serv=kegg&dbkey=kegg&keywords='
            + pathwayWithoutOrganism.replace(" ", "+")
            + '">'
            + pathway_name
            + "</a>"
        )
        ...
        linked_name = (
            '<a href="http://biocyc.org/HUMAN/substring-search?type=NIL&object='
            + encodedPathway
            + '">'
            + pathway_name
            + "</a>"
...
def query_gene_ids(genes, input_type):
    ...
    for r in result:
        if r[1]:  # if mapping was found
            ...
            id = r[1].split(",")[
                0
            ]  ## here we take only one of the mappings for simplicity
...
def query_over_representation_analysis(gene_ids, input_type, p_value_threshold):
    ...
    cpdb_results = zip(
        response._name,
        response._details,
        response._overlappingEntitiesNum,
        response._allEntitiesNum,
        response._pValue,
        response._qValue,
    )
    ...
    for result in cpdb_results:
        ...
        (
            cpdb_name,
            cpdb_details,
            pathway[OVERLAPPING_GENE_COUNT],
            cpdb_all_entities_num,
            pathway[P_VALUE],
            pathway[Q_VALUE],
        ) = result
        pathway[PATHWAY_NAME], pathway[DB] = parse_name(cpdb_name)
        pathway[GENE_COUNT], pathway[CORRECTED_GENE_COUNT] = parse_all_entities_num(
            cpdb_all_entities_num
        )
...
def parse_all_entities_num(cpdb_all_entities_num):
    ...
    corrected_all_entities_num = cpdb_all_entities_num[
        cpdb_all_entities_num.rfind("(") + 1 : -1
    ]
...
class ns0:
    ...
    class getAvailableAccessionTypes_Dec(
    ...
    class getAvailableAccessionTypesResponse_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
    ...
    class mapAccessionNumbersResponse_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
    ...
    class getAvailableFsetTypesResponse_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
    ...
    class getDefaultBackgroundSizeResponse_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
    ...
    class overRepresentationAnalysis_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
    ...
    class overRepresentationAnalysisResponse_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ...
                ZSI.TC.String(
                    pname=(ns, "overlappingEntitiesNum"),
                    aname="_overlappingEntitiesNum",
                    minOccurs=0,
                    maxOccurs="unbounded",
                    nillable=False,
                    typed=False,
                ...
                ZSI.TC.String(
                    pname=(ns, "allEntitiesNum"),
                    aname="_allEntitiesNum",
                    minOccurs=0,
                    maxOccurs="unbounded",
                    nillable=False,
                    typed=False,
    ...
    class enrichmentAnalysis_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ...
                ZSI.TC.String(
                    pname=(ns, "cpdbIdsMeasurements"),
                    aname="_cpdbIdsMeasurements",
                    minOccurs=1,
                    maxOccurs="unbounded",
                    nillable=False,
                    typed=False,
    ...
    class enrichmentAnalysisResponse_Dec(
        ZSI.TCcompound.ComplexType, ElementDeclaration
    ):
        ...
        def __init__(self, **kw):
            ...
            TClist = [
                ...
                ZSI.TC.String(
                    pname=(ns, "measuredEntitiesNum"),
                    aname="_measuredEntitiesNum",
                    minOccurs=0,
                    maxOccurs="unbounded",
                    nillable=False,
                    typed=False,
...
class cpdb_http_bindingSOAP:
    ...
    def getAvailableAccessionTypes(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#getAvailableAccessionTypes", **kw
        )
        # no output wsaction
    ...
    def mapAccessionNumbers(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#mapAccessionNumbers", **kw
        )
        # no output wsaction
    ...
    def getAvailableFsetTypes(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#getAvailableFsetTypes", **kw
        )
        # no output wsaction
    ...
    def getDefaultBackgroundSize(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#getDefaultBackgroundSize", **kw
        )
        # no output wsaction
    ...
    def overRepresentationAnalysis(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#overRepresentationAnalysis", **kw
        )
        # no output wsaction
    ...
    def enrichmentAnalysis(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#enrichmentAnalysis", **kw
        )
        # no output wsaction
    ...
    def getCpdbIdsInFset(self, request):
        ...
        # no input wsaction
        self.binding.Send(
            None, None, request, soapaction="cpdbns#getCpdbIdsInFset", **kw
        )
        # no output wsaction
...
getAvailableAccessionTypesResponse = (
    ns0.getAvailableAccessionTypesResponse_Dec().pyclass
)
...
overRepresentationAnalysisResponse = (
    ns0.overRepresentationAnalysisResponse_Dec().pyclass
)
