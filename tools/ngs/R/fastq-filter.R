# TOOL fastq-filter.R: "Filter contigs based on the number of expected errors" (Discards sequences which have more than the user specified number of expected errors. This tool helps to filter bad quality contigs after the paired reads have been merged in contigs. )
