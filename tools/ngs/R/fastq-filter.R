...
# PARAMETER qmax: "Maximum quality score accepted when reading FASTQ files" TYPE INTEGER FROM 0 DEFAULT 50 (Specify the maximum quality score accepted when reading FASTQ files. For recent Sanger/Illumina 1.8+ files value 41 is usual.)
