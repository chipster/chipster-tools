# TOOL single-cell-seurat-featureplot.R: "Seurat v5 -Visualize features in UMAP plot" (Color single cells on a UMAP dimensional reduction plot according to a feature, i.e. gene expression, PC scores, number of genes detected, etc.)
