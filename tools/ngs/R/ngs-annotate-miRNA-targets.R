# TOOL ngs-annotate-miRNA-targets.R: "Find miRNA targets" (Given a list of miRNA identifiers, fetches target gene predictions from the selected database.)
# INPUT normalized_mirna.tsv: normalized_mirna.tsv TYPE GENERIC 
# OUTPUT mirna_targets.tsv: mirna_targets.tsv 
# PARAMETER species: Species TYPE [human: human, mouse: mouse, rat: rat] DEFAULT human (The species for which the miRNAs have been analyzed.)
# PARAMETER database: Database TYPE [miranda: miRanda, mirbase: miRBase, mirtarget2: MirTarget, pictar: PicTar, tarbase: TarBase, targetscan: TargetScan] DEFAULT mirtarget2 (The database from which to search for predicted target genes.)
