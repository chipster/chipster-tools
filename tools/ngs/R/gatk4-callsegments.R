# TOOL gatk4-callsegments.R: "Call segmented copy number variants" (Call segments as amplified, deleted, or copy number neutral given files containing tangent-normalized read counts by target and a list of segments. GATK4)
