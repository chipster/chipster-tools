...
data.anchors <- FindIntegrationAnchors(object.list = list(group1, group2), dims = 1:CCstocompute)
data.combined <- IntegrateData(anchorset = data.anchors, dims = 1:CCstocompute)
