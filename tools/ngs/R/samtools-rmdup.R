# TOOL samtools-rmdup.R: "Remove duplicate reads from BAM" (Removes potential PCR duplicates. You have to indicate if your data is single end or paired end. This tool is based on the SAMtools package.)
