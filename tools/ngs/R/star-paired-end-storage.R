# TOOL star-paired-end-storage.R: "STAR for paired end reads and large input data" (This tool uses STAR to align large paired-end reads to a publicly available reference genome. You need to supply the paired-end reads in FASTQ format. Use this tool if you have more than 200 million reads per sample.)
...
# PARAMETER organism: "Genome" TYPE [Homo_sapiens.GRCh38, Mus_musculus.GRCm39, Rattus_norvegicus.mRatBN7] DEFAULT Homo_sapiens.GRCh38 (Genome that you would like to align your reads against.)
