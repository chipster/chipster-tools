...
# PARAMETER region: "Region to retrieve alignments for" TYPE STRING DEFAULT 1 (The genomic region for which you would like to retrieve the alignments for. Please see the manual page for details.)
