...
# PARAMETER OPTIONAL bin_sizes: "Bin sizes" TYPE STRING DEFAULT "8, 12" (List here the bin sizes, separated by comma)
...
system("mkdir input_folder; cd input_folder; tar -xvzf ../files.tar; cd binned_outputs; rm -rf square_002um; rm -rf square_008um/analysis; rm -rf square_008um/raw*; rm -rf square_012um/analysis; rm -rf square_012um/raw*; cd square_008um; ls; cd ..; ls")
