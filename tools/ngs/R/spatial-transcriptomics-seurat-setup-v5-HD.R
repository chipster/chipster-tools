...
system("pwd; cd input_folder; pwd; cd input_folder; ls -lth; cd spatial; pwd; ls -lth")
system("cd input_folder; pwd; chmod -R o=r; cd input_folder; ls -lth; cd spatial; pwd; ls -lth")
