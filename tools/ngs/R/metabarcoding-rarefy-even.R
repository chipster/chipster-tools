# TOOL metabarcoding-rarefy-even.R: "Rarefy OTU/ASV data to even depth" (Resamples a phyloseq OTU table such that all samples have the same sequencing depth, and saves the resulting object as an Rda file. Requires a phyloseq object in Rda format as the input.)
