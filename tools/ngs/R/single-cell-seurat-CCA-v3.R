# TOOL single-cell-seurat-CCA-v3.R: "Seurat v3 -Combine two samples" (This tool can be used to integrate data and combine two Seurat objects for later joined analysis. The two objects need to be named when created in the Seurat setup tool.) 
