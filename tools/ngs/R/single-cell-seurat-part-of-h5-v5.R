# TOOL single-cell-seurat-part-of-h5-v5.R: "Seurat v5 - BETA Extract only gene expression data from a multiomics h5 object" (In case you have a multiomics h5 object, you can use this tool to only get the gene expression matrix in tsv format. This matrix can be used as an input for the setup tool.)
