...
# PARAMETER OPTIONAL pval.cutoff.conserved: "Conserved markers: p-value cutoff" TYPE DECIMAL FROM 0 TO 1 DEFAULT 0.05 (Cutoff for the adjusted p-value of the conserved cluster marker genes: by default, adjusted p-values bigger than 0.05 in any sample are filtered out.)
