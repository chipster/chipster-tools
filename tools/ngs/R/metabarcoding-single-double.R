# TOOL metabarcoding-single-double.R: "Remove OTUs/ASVs with specified number of occurrences" (Filters a phyloseq object so that only OTUs with more occurrences than the selected threshold are retained. The resulting object is saved in Rda format. Requires a phyloseq object in Rda format as the input. The main use case of the tool is to remove OTUs with 0-2 occurrences.)
