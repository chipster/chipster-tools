# TOOL single-cell-scater-QC-v5.R: "Scater -QC v5" (Quality control with Scater. This tool takes as an input an Seurat object, and gives an pdf file with several quality control plots. The content of the plot depends on the contents of the Seurat object, for example if you use object with cell cycle scores, those will be included in the plots.)
