# TOOL single-cell-seurat-find-markers-v5.R: "Seurat v5 -Find differentially expressed genes between clusters" (Find genes which are differentially expressed between given clusters or between a specified cluster and all the other cells.)
