...
# PARAMETER OPTIONAL add.colors: "Add custom colors for clusters" TYPE [red, blue, green, pink] DEFAULT pink (tesktiä)
# PARAMETER OPTIONAL label.size: "sajflksaj" TYPE INTEGER DEFAULT 5 (Valitse numero)
