# TOOL hisat2-single-end-with-index-building.R: "HISAT2 for single end reads and own genome" (Aligns single end RNA-seq reads to a user-supplied genome. You nedd to supply the genome in FASTA format.)
