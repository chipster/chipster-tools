# TOOL hisat2-paired-end-with-index-building-storage.R: "HISAT2 for paired end reads, own genome and large samples" (This tool uses HISAT2 to align paired-end reads to a provided reference genome. You need to supply the paired-end reads in FASTQ format. You also need to provide the reference genome as input either in FASTA format or as a tar package with a HISAT2 index.)
