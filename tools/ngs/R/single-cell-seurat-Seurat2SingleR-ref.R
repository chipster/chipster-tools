# TOOL single-cell-seurat-Seurat2SingleR-ref.R: "Seurat v5 - Build own reference for SingleR" (With this tool you can make a custom reference SummarizedExperiment object, which can be used to annotate cells in seurat objects)
