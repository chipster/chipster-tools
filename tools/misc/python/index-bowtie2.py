...
def main():
    ...
    run_process([bowtie2_build, "--threads", chipster_threads_max, input_fa, fasta_basename])
    ...
    if fasta_chr != index_chr:
        raise RuntimeError("bowtie2 indexing of genome " + fasta_basename + " failed. Chromosomes in fasta: " + str(fasta_chr) + ", chromosomes in index: " + str(index_chr))
